VPK adaptation of Protocol Buffers v(3).22.0
======

(1) )The correct set of files can be pulled using Cocoapods - 
`pod 'Protobuf', '3.22.0'`
    OR from `https://github.com/protocolbuffers/protobuf`
(2) VPKProtobuf: change `GPB` namespace`VPKGPB` (see `_namespaces.sh`)
(3) add VPKProtobuf files directly to project
(3) deintegrate and remove pods, no longer required
