...
#pragma mark - VPKGPBAnyRoot

@implementation VPKGPBAnyRoot
...
static VPKGPBFileDescription VPKGPBAnyRoot_FileDescription = {
...
@implementation VPKGPBAny

@dynamic typeURL;
@dynamic value;

typedef struct VPKGPBAny__storage_ {
...
+ (VPKGPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    static VPKGPBMessageFieldDescription fields[] = {
      {
        ...
        .number = VPKGPBAny_FieldNumber_TypeURL,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(VPKGPBAny__storage_, typeURL),
      ...
      },
      {
        .name = "value",
        .dataTypeSpecific.clazz = Nil,
        .number = VPKGPBAny_FieldNumber_Value,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(VPKGPBAny__storage_, value),
    ...
    VPKGPBDescriptor *localDescriptor =
        [VPKGPBDescriptor allocDescriptorForClass:VPKGPBObjCClass(VPKGPBAny)
                                   messageName:@"Any"
                               fileDescription:&VPKGPBAnyRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(VPKGPBMessageFieldDescription))
                                   storageSize:sizeof(VPKGPBAny__storage_)
