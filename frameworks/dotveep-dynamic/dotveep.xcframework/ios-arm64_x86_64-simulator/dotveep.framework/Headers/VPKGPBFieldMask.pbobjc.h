 ...
 **/
VPKGPB_FINAL @interface VPKGPBFieldMaskRoot : VPKGPBRootObject
@end

#pragma mark - VPKGPBFieldMask

typedef VPKGPB_ENUM(VPKGPBFieldMask_FieldNumber) {
  VPKGPBFieldMask_FieldNumber_PathsArray = 1,
};
 ...
 **/
VPKGPB_FINAL @interface VPKGPBFieldMask : VPKGPBMessage
