 ...
 **/
VPKGPB_FINAL @interface VPKGPBTimestampRoot : VPKGPBRootObject
@end

#pragma mark - VPKGPBTimestamp

typedef VPKGPB_ENUM(VPKGPBTimestamp_FieldNumber) {
  VPKGPBTimestamp_FieldNumber_Seconds = 1,
  VPKGPBTimestamp_FieldNumber_Nanos = 2,
};
 ...
 **/
VPKGPB_FINAL @interface VPKGPBTimestamp : VPKGPBMessage
