 ...
 **/
VPKGPB_FINAL @interface VPKGPBDurationRoot : VPKGPBRootObject
@end

#pragma mark - VPKGPBDuration

typedef VPKGPB_ENUM(VPKGPBDuration_FieldNumber) {
  VPKGPBDuration_FieldNumber_Seconds = 1,
  VPKGPBDuration_FieldNumber_Nanos = 2,
};
 ...
 **/
VPKGPB_FINAL @interface VPKGPBDuration : VPKGPBMessage
